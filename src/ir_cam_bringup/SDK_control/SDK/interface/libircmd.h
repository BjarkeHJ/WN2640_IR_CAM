 ...
 * Support for WN2384T, WN2256T, SE51280T, TC2-C, LC-RSxxx series
 *
 * @param[in] handle ircmd's handle
 ...
 * Support for WN2/TIF series, SE51280 and WN2384T and WN2256T
 *
 * @param[in]  handle ircmd's handle
 *
 * @return see IrlibError_e
...
/**
 * @brief Gets the device TFpa
 * Support for WN2384T
 *
 * @param[in]  handle ircmd's handle
 * @param[in]  K, slope
 * @param[in]  Vtemp0
 * @param[in]  current Vtemp
 * @param[in]  T0, offset
 * @param[out] TFpa.
 *
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_t_fpa_get(IrcmdHandle_t* handle, float k, float vtemp0, float vtemp, float t0, float* res);
 ...
 * Not support for TC2C, SE51280T and SE5640
 *
 * @param[in]  handle ircmd's handle
...
/**
 * @brief Set tir stream source mode status
 * Only support for G1280S CS640 CSS081Y CSS081
 *
 * @param[in] handle ircmd's handle
 ...
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_tir_stream_source_set(IrcmdHandle_t* handle, int status);
 ...
 * Support for WN2/TIF series, SE51280/SE51280T, LC-RSxxx series, TC2-C and WN2384T, WN2256T
 *
 * @param[in] handle ircmd's handle
 ...
 * Support for WN2/TIF series, WN2384T, WN2256T, SE51280T, LC-RSxxx series, TC2-C
 *
 * @param[in] handle ircmd's handle
...
/**
* @brief the mode of video output
*/
typedef enum {
    VIDEO_OUTPUT_MODE_INVALID = -1,
    MODE_LG_30HZ_TEMP = 0,       //Low Gain, 30Hz, Temp
    MODE_HG_30HZ_TEMP = 1,       //High Gain, 30Hz, Temp
    MODE_HHG_30HZ_IMG = 2,       //2High Gain, 30Hz, Image
    MODE_HG_60HZ_IMG  = 3,       //High Gain, 60Hz, Image
...
typedef struct {
    ...
    int video_output_mode;              //see video_output_mode_e
    int video_output_info_sw;           //see basic_enable_status_e
}VideoOutputInfo_t;

/**
 * @brief Choose the appropriate mode to start stream
 * @support TC2-C USB,DVP,MIPI,VO_SPI, fill status, format and num
 *          LC-RSxxx series USB,DVP,MIPI,VO_SPI, fill status, format and num
 *          SE51280T MIPI,DVP, fill status, format and num
 *          WN2384T USB,DVP,MIPI, fill status, format and num
 *          WN2256T USB,DVP,MIPI, fill status, format and num
 *
 * @param[in]  handle ircmd's handle
 ...
 * @support WN2384T, WN2256T, SE51280T, LC-RSxxx series and TC2-C
 *
 * @param[in]   handle ircmd's handle
...
/**
 * @brief Set palette analog video output info
 ...
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_palette_analog_set(IrcmdHandle_t* handle, int status, int format);

/**
 * @brief Get palette analog video output info
 * @support WN2/TIF series
 * @param[in]  handle ircmd's handle
 * @param[in]  status see basic_enable_status_e
 * @param[in]  format see adv_video_output_format_e, only support ADV_NTSC_FORMAT and ADV_PAL_FORMAT
 ...
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_palette_analog_get(IrcmdHandle_t* handle, int* status, int* format);
...
*/
typedef enum {
    BASIC_DEFAULT_MODE = 0,             //for G1280s CS640 WN2 TC2-C LC-RSxxx series
    ...
    BASIC_RESERVE1_MODE = 8,            //for WN2 TC2-C LC-RSxxx series
    ...
    BASIC_TEMP_MEASURE_MODE = 14,       //for TC2-C LC-RSxxx series
    BASIC_OUTDOORS_MODE = 15,           //for TC2-C LC-RSxxx series
...
/**
 * @brief Set the NUC-T bypass switch's status
 *
 * @param[in]  handle ircmd's handle
 * @param[in]  status see basic_enable_status_e
 *
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_bypass_nuct_set(IrcmdHandle_t* handle, int status);

/**
 * @brief Get vtemp_start
 *
 * @param[out]  vtemp_start
 *
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_vtemp_start_get(IrcmdHandle_t* handle, uint32_t* vtemp_start);

/**
 * @brief Get the NUC-T bypass switch's status
 *
 * @param[in]  handle ircmd's handle
 * @param[out] status see basic_enable_status_e
 *
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_bypass_nuct_get(IrcmdHandle_t* handle, int* status);
 ...
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_isothermal_limit_get(IrcmdHandle_t* handle, int* high_temp, int* low_temp);
 ...
 * @return see IrlibError_e
 */
DLLEXPORT IrlibError_e adv_isothermal_limit_set(IrcmdHandle_t* handle, int high_temp, int low_temp);
 ...
 * Support for TC2-C LC-RSxxx series
 ...
 * Support for WN2384T, WN2256T, SE51280T, LC-RSxxx series and TC2-C
 *
 * @param[in] handle ircmd's handle
...
typedef enum {
    ...
    /// include dead pxiel data, recover data and tpd data, support for CS640, G1280S, WN2384T, WN2256T, SE51280T, LC-RSxxx series and TC2-C
    ...
    /// restore the system function parameter, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T and P2L
    ...
    /// restore k value to default, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_RESTORE_K_VALUE = 3,
    /// restore dpc calib data to default, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_RESTROE_DPC_DATA = 4,
    /// restore rmcover calib data to default, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_RESTROE_RMCOVER_DATA = 5,
    /// restore one point tpd calib data to default, support for WN2384T, WN2256T, SE51280T, LC-RSxxx series, TC2-C and P2L
    BASIC_RESTORE_TPD_DATA = 6,
    /// restore profession scene level, support for TC2-C LC-RSxxx series
    BASIC_RESTORE_PROFESSION_SCENE_LEVEL = 7,
    /// restore two points tpd calib data, support for WN2384T, WN2256T, SE51280T, LC-RSxxx series and TC2-C
...
typedef enum {
    ...
    /// save the changed system function parameter, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T and P2L
    ...
    /// save k value after calib, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_SAVE_K_VALUE = 2,
    /// save dpc calib data after calib, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_SAVE_DPC_DATA = 3,
    /// save rmcover calib data after calib, support for WN2/TIF series, SE51280/SE51280T, WN2384T, WN2256T, LC-RSxxx series, TC2-C and P2L
    BASIC_SAVE_RMCOVER_DATA = 4,
    /// save one point tpd calib data after calib, support for WN2384T, WN2256T, SE51280T, LC-RSxxx series, TC2-C and P2L
    BASIC_SAVE_TPD_DATA = 5,
    /// save video output format, support for WN2/TIF series, SE51280/SE51280T, LC-RSxxx series, TC2-C, WN2384T and WN2256T
    BASIC_SAVE_VIDEO_OUTPUT_FORMAT = 6,
    /// save profession scene level, support for TC2-C LC-RSxxx series
    BASIC_SAVE_PROFESSION_SCENE_LEVLE = 7,
    /// save two points tpd calib data after calib, support for WN2384T, WN2256T, SE51280T, LC-RSxxx series and TC2-C
